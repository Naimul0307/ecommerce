                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="confirm('Are you want to delete this Product?') || event.stopImmediatePropagation()" style="margin-left: 15px" wire:click.prevent="deleteCategory({{$product->id}})"><i class="fa fa-times fa-2x text-danger"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                              </tbody>
