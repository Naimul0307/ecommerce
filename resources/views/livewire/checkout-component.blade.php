                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input  type="text" name="zip-code" value="" placeholder="Province" wire:model ="province">
                                    @error('province') <span class="text-danger">{{$message}}</span> @enderror
                                </p>

                                <p class="row-in-form fill-wife">
                                    <label class="checkbox-field">
                                        <input name="different-add" id="different-add" value="1" type="checkbox" wire:model.live="ship_to_different">
                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                ...
                                <p class="row-in-form">
                                    ...
                                    @error('s_moblie') <span class="text-danger">{{$message}}</span> @enderror
                                </p>
                                ...
                                <p class="row-in-form">
                                    <label for="zip-code">Province:</label>
                                    <input  type="text" name="zip-code" value="" placeholder="Province" wire:model ="s_province">
                                    @error('province') <span class="text-danger">{{$message}}</span> @enderror
                                </p>
                            </div>
                        </div>
