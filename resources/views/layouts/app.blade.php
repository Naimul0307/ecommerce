				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: +971544800863" href="#" ><span class="icon label-before fa fa-mobile"></span>+971544800863</a>
								</li>
							</ul>
						</div>
						<div class="topbar-menu right-menu">
							<ul>
                                ...
                                <li class="menu-item menu-item-has-children parent" >
                                    ...
                                    <li class="menu-item">
                                        <a title="All Coupon" href="{{route('admin.orders')}}">All Order</a>
                                    </li>
                                        <li class="menu-item">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="{{route('home.index')}}" class="link-to-home"><img src="{{asset('assets/images/logo-top-1.png')}}" alt="mercado"></a>
						</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-list-item apps-list">
										<ul>
											<li><a href="#" class="link-to-item" title="our application on apple store"><figure><img src="{{asset('asset/images/brands/apple-store.png')}}" alt="apple store" width="128" height="36"></figure></a></li>
											<li><a href="#" class="link-to-item" title="our application on google play store"><figure><img src="{{asset('asset/images/brands/google-play-store.png')}}" alt="google play store" width="128" height="36"></figure></a></li>
										</ul>
									</div>
								</div>
							</div>
